...
# Ivy's testing global env -- append
GLOBAL_ENV = (
    _('append', 2, lambda x: x.car + x.cdr.car,
      _('list?', 1, lambda x: isinstance(x.car, list),
        _('error', 2, _error,
          _('globals', 0, _globals,
                    None))))
)

# Ivy's testing global env -- add1
GLOBAL_ENV = (
    _('add1', 1, lambda x: x.car + 1,
...
# Ivy's testing global env -- not
GLOBAL_ENV = (
    _('not', 1, lambda x: ~x.car,
      _('boolean?', 1, lambda x: isinstance(x.car, bool),
        _('error', 2, _error,
          _('globals', 0, _globals,
                    None))))
)
